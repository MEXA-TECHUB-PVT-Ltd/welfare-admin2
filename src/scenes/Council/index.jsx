...
const Team = () => {
  ...
  const submitHandler = async (e) => {
      ...
      setTimeout(() => {
        ...
        axios.post(`${url}create-dept`, {
            ...
            let timerInterval
            Swal.fire({
              title: 'Created Council Successfully',
              timer: 2000,
  ...
  const columns = [
    // { field: "_id", headerName: "ID" },
    {
      ...
      renderCell: (row) => {
        return (
             <img style={imgStyle} src={`${url}${row.row.departmentImg}`} />
    ...
    <>
      <Box display="flex" justifyContent="space-between" p={2} style={{ borderBottom: '1px solid #adadad' }}>
        <Breadcrumbs aria-label="breadcrumb">
          ...
          <Typography color="text.primary">Council</Typography>
        </Breadcrumbs>
      ...
      <Grid container spacing={2} >
          ...
          <Header title="Council" subtitle="Managing the Council" />
                  ...
                  <Typography variant="h5" mt={2} style={{ color: '#7e7e7e', fontWeight: 700 }} gutterBottom>
                      Select Image
                          ...
                          <Grid item xs={12} md={6}>
                            ...
                            <input mt={2} type="file" multiple onChange={(e) => onFileChange(e.target.files[0])} />
                          </Grid>
                           <Grid item xs={12} md={6}>
                  <Typography variant="h5" mt={2} style={{ color: '#7e7e7e', fontWeight: 700 }} gutterBottom>
                      Department Name
                      ...
                      Description
                          ...
                          <Grid item xs={12} md={6}>
                             ...
                             <TextField id="outlined-basic" style={{width:'100%'}}
                              ...
                              label="Description" variant="outlined" required/>
                          </Grid>
