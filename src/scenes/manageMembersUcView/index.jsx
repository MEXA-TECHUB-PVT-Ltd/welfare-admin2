        ...
        <Grid container spacing={2} >
          <Grid item xs={12} md={12} >
            <Breadcrumbs aria-label="breadcrumb">
              ...
              <Link underline="hover" color="inherit" href="/UCGroupMembers">
                <Typography color="text.primary">Manage UC Members</Typography>
              </Link>
                          ...
                          >
                            ...
                            <TableCell style={TextColor} component="th" scope="row">
                              ...
                              >
                                ...
                                <TableCell style={TextColor} component="th" scope="row">
                                  {data.educationalQualification === undefined ? <span>Null</span> : data.educationalQualification}
                              ...
                              >
                                ...
                                <TableCell style={TextColor} component="th" scope="row">
                                  {data.address === undefined ? <span>Null</span> : data.address}
